...
big,
CASE
WHEN drink_name = 'CREVICE_SPIKE' AND big THEN 1
ELSE add_opt
END AS add_opt,
serve
FROM Input
...
wait,
CASE
WHEN adelhyde + bronson_extract + powdered_delta + flanergide + karmotrine <= 10 THEN big
ELSE 0
END AS big,
add_opt
FROM RefinedInput
...
SELECT
CASE
WHEN big THEN 2 * adelhyde
ELSE adelhyde
END AS adelhyde,
CASE
WHEN big THEN 2 * bronson_extract
ELSE bronson_extract
END AS bronson_extract,
CASE
WHEN big THEN 2 * powdered_delta
ELSE powdered_delta
END AS powdered_delta,
CASE
WHEN big THEN 2 * flanergide
ELSE flanergide
END AS flanergide,
CASE
WHEN big AND karmotrine != -1 THEN 2 * karmotrine
ELSE karmotrine
END AS karmotrine,
add_ice,
age,
