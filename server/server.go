...
func CreateMultiplexedProcessor(recipeActionServiceProcessor *action.RecipeActionServiceProcessor, drinkRecipeServiceProcessor *recipe.DrinkRecipeServiceProcessor, screenElementServiceProcessor *element.ScreenElementServiceProcessor, commandServiceProcessor *command.CommandServiceProcessor) thrift.TProcessor {
...
func CreateCommandServer(transportFactory thrift.TTransportFactory, protocolFactory thrift.TProtocolFactory, serverSocket thrift.TServerTransport, recipes *[]DrinkRecipe, screenElements *[]ScreenElement) (*thrift.TSimpleServer, error) {
	wire.Build(thrift.NewTSimpleServer4, CreateMultiplexedProcessor, action.NewRecipeActionServiceProcessor, recipe.NewDrinkRecipeServiceProcessor, element.NewScreenElementServiceProcessor, command.NewCommandServiceProcessor, NewRecipeActionServiceHandler, NewDrinkRecipeServiceHandler, NewScreenElementServiceHandler, NewCommandServiceHandler)
	return nil, nil
}
